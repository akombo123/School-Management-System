...
@section('content')
            ...
            <div class="app-content-header"> <!--begin::Container-->
             ...
             <div class="col-sm-12" style="text-align:right">
                            <a href="{{ url('admin/class/add') }}" class="btn btn-primary" style="margin-right: 2% ; margin-bottom:1%"> Add New Class</a>
                        </div>
                        ...
                        <div class="col-md-12"> <!--begin::Quick Example-->
                            <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                                <div class="card-header">
                                    <div class="card-title">Search Class</div>
                                ...
                                <form action="" method="get"> <!--begin::Body-->
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-3"> <label  class="form-label">Status</label> <input type="text" class="form-control" name="status" value="{{ Request::get('status') }}">
                                            </div>
                                            <div class="mb-3 col-md-3"><button class="btn btn-primary" style="margin-top: 30px  " type="submit">Search</button>
                                            <a href="{{ url('admin/class/list') }}" class="btn btn-success" style="margin-top: 30px" type="submit">Reset</a>
                                            </div>
                                        </div>
